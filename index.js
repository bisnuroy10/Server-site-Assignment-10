...
const uri = `mongodb+srv://${process.env.DB_user}:${process.env.DB_password}@cluster0.e1cygwf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.get("/", (req, res)=>{
res.json({ message: "Your server is completely ready to run." });
});
